...
#define PARTITION_KERNEL_THRUST     2
...
#define PARTITION_DEFAULT_KERNEL PARTITION_KERNEL_THRUST    // Partition
...
#define DEFAULT_KRUSKAL_THRESHOLD 1000                    // Kruskal Threshold
